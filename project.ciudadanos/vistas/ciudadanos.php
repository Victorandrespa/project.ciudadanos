                ...
                <div class="modal-body">
                    <form action="../main/functions.php" method="post">
                        ...
                        <div class="d-flex justify-content-center mt-3">
                            <button type="submit" class="form-control btn btn-outline-primary w-50 " name="btn_insertar" id="btn_insertar">Agregar Registro</button>
                        </div>
                    </form>
                </div>
                ...
                ?>
                    <tr>
                        ...
                        <td class="d-flex flex-row">
                            <form action="paginaEditar.php" method="post">
                                <input type="hidden" name="h_codigor_editar" id="h_codigor_editar" value="<?php echo $datos["dpi"]; ?>">
                                <button type="submit" name="btn_editar" id="btn_editar" class="btn btn-outline-primary me-1"><i class="bi bi-pencil-square"></i></button>
                            </form>
                            <form action="../main/functions.php" method="post">
                                <input type="hidden" name="h_codigor_borrar" id="h_codigor_borrar" value="<?php echo $datos["dpi"]; ?>">
                                <button type="button" name="btn_eliminar" id="btn_eliminar" class="btn btn-outline-danger ms-1"><i class="bi bi-trash3-fill"></i></button>
                            </form>
                        </td>
                    </tr>
                <?php
